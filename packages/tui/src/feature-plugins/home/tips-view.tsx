...
const TIPS: Tip[] = [
  // ── Neko ──────────────────────────────────────────────────────────────────
  "ARIA orchestrates a team: it discusses, implements, and peer-reviews every non-trivial change",
  "Run {highlight}/discuss{/highlight} to have ARIA convene the right specialists and debate an approach first",
  "Run {highlight}/experiment{/highlight} to run a full scientific-method experiment with peer review",
  "Run {highlight}/tasks{/highlight} to build a backlog the team works through one task at a time",
  "Run {highlight}/changeset{/highlight} to review the work as a PR, then approve (commit) or discard",
  "Run {highlight}/knowledge{/highlight} to record facts the whole team recalls compactly",
  "Use {highlight}@red_team{/highlight}, {highlight}@coder{/highlight}, or {highlight}@analyst{/highlight} to pull a specialist into a message",
  "Hook agents to different providers with {highlight}agent.<name>.model{/highlight} in your config",
  // ── opencode ──────────────────────────────────────────────────────────────
  "Type {highlight}@{/highlight} followed by a filename to fuzzy search and attach files",
  "Start a message with {highlight}!{/highlight} to run shell commands directly (e.g., {highlight}!ls -la{/highlight})",
  (shortcuts) => press(shortcuts.agentCycle(), "to cycle between ARIA, Plan, and your agents"),
