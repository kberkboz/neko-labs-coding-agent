...
import { BYPASS_PERMISSIONS_KEY } from "../../neko-settings"
...
export function PermissionPrompt(props: { request: PermissionRequest; directory?: string }) {
  ...
  // Bypass permissions: when the toggle is on, auto-approve this request instead
  // of prompting. (Dangerous — only enabled deliberately via /bypass.)
  onMount(() => {
    if (!kv.get(BYPASS_PERMISSIONS_KEY, false)) return
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          <text fg={theme.textMuted}>Tell Neko what to do differently</text>
        </box>
      </box>
      <box
