...
// Brand tagline shown beneath the wordmark on the home screen. A single line so
// it can never overlap itself when the container is tight.
export function NekoTagline() {
  const { theme } = useTheme()
  return (
    <box alignItems="center" flexShrink={0} paddingTop={1}>
      <text fg={theme.textMuted} selectable={false}>
        ARIA + specialists · discuss · implement · peer-review
      </text>
    </box>
  )
}
