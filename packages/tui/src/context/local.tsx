      ...
      return {
        ...
        color(name: string) {
          ...
          if (agent?.color) {
            ...
            // Resolve a theme-key color; fall back to the rotating palette when
            // the value isn't a valid theme key (e.g. an ANSI name like
            // "magenta") so a bad color never crashes the TUI.
            const resolved = theme[color as keyof typeof theme] as RGBA | undefined
